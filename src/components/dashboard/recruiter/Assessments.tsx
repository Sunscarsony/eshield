    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="all" className="w-full">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="text-sm space-y-1">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{Math.round((assessment.completed / assessment.assigned) * 100)}%</span>
                      </div>
                    </div>
        ...
        <TabsContent value="coding" className="py-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {assessments.filter(a => a.type === "Coding").map((assessment) => (
              <Card key={assessment.id} className="glass-card hover:shadow-md transition-shadow">
                <CardHeader className="pb-2">
                  <div className="flex justify-between">
                    <CardTitle className="text-lg">{assessment.title}</CardTitle>
        ...
        <TabsContent value="design" className="py-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {assessments.filter(a => a.type === "Design").map((assessment) => (
              <Card key={assessment.id} className="glass-card hover:shadow-md transition-shadow">
                <CardHeader className="pb-2">
                  <div className="flex justify-between">
                    <CardTitle className="text-lg">{assessment.title}</CardTitle>
        ...
        <TabsContent value="quiz" className="py-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {assessments.filter(a => a.type === "Multiple Choice").map((assessment) => (
              <Card key={assessment.id} className="glass-card hover:shadow-md transition-shadow">
                <CardHeader className="pb-2">
                  <div className="flex justify-between">
                    <CardTitle className="text-lg">{assessment.title}</CardTitle>
